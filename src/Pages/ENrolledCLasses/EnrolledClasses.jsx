...
const EnrolledClasses = () => {
    ...
    return (
        ...
        <div>
            ...
            {/* <Helmet>
                <title>AISportsHub | Enrolled Classes</title>
            </Helmet> */}

            <h1 className="text-xl mt-5 mb-7 lg:mb-9 font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">My Enrolled <span className="text-teal-500">Classe&#39;s</span></h1>
                    ...
                    <tbody>
                        {
                            enrolledClasses?.map((sclass, index) => (
                                <tr key={index} className="bg-white border-b font-semibold  text-black dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <th scope="row" className="flex items-center mt-2 px-8 py-4 text-gray-900 whitespace-nowrap dark:text-white">
